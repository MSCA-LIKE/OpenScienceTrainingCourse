...
\begin{frame}{What to do now}
	...
	\begin{columns}[t]
		...
		\begin{itemize}
		    \item \textlink{https://www.nature.com/articles/d41586-019-03869-7}{What institutions can do to improve science communication
			.} (nature.com, 2019)
		\end{itemize}
		\end{block}
		...
		\begin{block}{Assignment 1: Implementation Case Study}
			...
			\begin{itemize}
			    \item See the \textlink{https://github.com/LIKE-ITN/OpenScienceTrainingCourse/tree/master/09_assignment1/readme.md}{guidance on GitHub}.
			\end{itemize}
		\end{block}
