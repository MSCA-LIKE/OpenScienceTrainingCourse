...
Notes written by Andy Clifton, U. Stuttgart [![](https://orcid.org/sites/default/files/images/orcid_16x16.png) https://orcid.org/0000-0001-9698-5083](https://orcid.org/0000-0001-9698-5083). These notes are based on the first course held in October 2020. For more information, see [the presentation accompanying the seminar](../beamer/main.pdf).
...
So, how can STEM professionals tell people about what they did? 
...
Unfortunately, this same ability to filter out information works against a STEM professional who is trying to get their material noticed. Professional communications can often just be part of the background noise and rarely become important enough to act upon.
...
We can therefore speak of _informative_, _emotive_, and _provocative_ communications styles:


| Style           | Goal             | Factual content | Emotional content | Example                        |
|-------------|------------------|-----------------|-------------------|--------------------------------|
| **Informative** | to inform        | high            | low to none       | "the car is red"               |
| **Emotive** | to make you care | middle          | mid to high       | "the car is coming toward you" |
| **Provocative** | to make you act  | low to none     | high              | "run!"                         |
...
| Annual average temperatures for the globe. Source: [Image by Ed Hawkins (University of Reading)](https://showyourstripes.info/). Used under CC BY 4.0 license. | Source: Photo by [Mika Baumeister](https://unsplash.com/@mbaumi) on [https://unsplash.com](Unsplash). | Source: [German Federal Centre for Health Education (BZgA)](https://www.infektionsschutz.de/mediathek/infografiken.html). |

STEM communications usually stay in the _informative_ part of the communications spectrum. This means that they rarely make people care, and even more rarely make people act. 
...
### Tell a good story
Now that we understand the mechanics of communication, we should think more about the content. Here, stories help.
...
We now see that we might need several different communications attempts before someone acts. 
...
You will probably have to target several different audiences before someone acts. For example:
...
## A case study in STEM communications
...
So, they choose a familiar communications mix to promote their work:
...
|              |             |
|------------------|-----------------|
| ![](comms_process.png) |  ![](science_comms.png) |
| ![](online_comms.png) |  ![](collaborative_comms.png) |

## License
These notes are published under the [Creative Commons CC BY 4.0 license](https://creativecommons.org/licenses/by/4.0/). Please note that some of the materials used may have their own licenses.
...
## Course progress
| Previous: [Self-study 3: "Implementing open science"](../../06_selfstudy4/readme.md) | [Course outline](../../readme.md#course-outline) | Next: [Self-study 4: "Communicate!"](../../08_selfstudy4/readme.md) |
| -- | -- | -- |
