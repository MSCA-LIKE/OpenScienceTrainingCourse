	...
	\begin{columns}[t]
		...
		% Findable
		    ...
		    \begin{block}{Accessible}
			    This presentation is archived at \textlink{http://dx.doi.org/10.5281/zenodo.4011505}{Zenodo.org}. The source code is available through \textlink{https://github.com/LIKE-ITN/OpenScienceTrainingCourse/tree/master/seminar1/beamer}{GitHub}.
		    \end{block}
        \end{column}
