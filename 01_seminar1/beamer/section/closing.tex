...
\begin{frame}{What to do now}
	...
	\begin{columns}[t]
		...
		\begin{block}{Seminar 2: Guiding principles}
			...
			\begin{itemize}
				\item \textlink{https://github.com/LIKE-ITN/OpenScienceTrainingCourse/blob/master/seminar2/readme.md}{Seminar materials on GitHub}
			\end{itemize}
		\end{block}
	...
	\begin{columns}[t]
		...
		% Findable
		    \begin{block}{Findable}
			    This presentation has a DOI (\textlink{http://dx.doi.org/10.5281/zenodo.4011505}{10.5281/zenodo.4011505}) and has been tagged with appropriate metadata.
		    \end{block}

		    % accessible
		    \begin{block}{Accessible}
			    This presentation is archived at \textlink{http://dx.doi.org/10.5281/zenodo.4011505}{Zenodo.org}. The source code is available through \textlink{https://github.com/LIKE-ITN/OpenScienceTrainingCourse/tree/master/01_seminar1/beamer}{GitHub}.
		    \end{block}
        \end{column}
